  ...
  return (
    <div className="pb-20 pt-36">
      ...
      />
        ...
        Hi, I&apos;m Ayomide, a Next.js Developer based in Lagos, Nigeria. I specialize in crafting dynamic and responsive web applications using Next.js, React, and TypeScript. With a passion for clean code and innovative design, I bring ideas to life on the web. Whether you need a sleek portfolio or a robust e-commerce platform, I&apos;m here to help you create seamless digital experiences. Let&apos;s collaborate and turn your vision into reality!
        </p>
